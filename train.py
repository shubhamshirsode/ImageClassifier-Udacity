...
train_data, trainloader, v_loader, testloader = futils.load_data(where[0])

model, optimizer, criterion = futils.nn_setup(structure,dropout,hidden_layer1,lr,power)

futils.train_network(model, optimizer, criterion, epochs, 20, trainloader, power, v_loader)

futils.save_checkpoint(path,structure,hidden_layer1,dropout,lr, epochs, train_data, model)
