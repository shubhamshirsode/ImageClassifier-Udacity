...
def train_network(model, criterion, optimizer, epochs = 3, print_every=20, loader='', power='gpu', vloader=''):
    '''
...
def save_checkpoint(path='checkpoint.pth',structure ='densenet121', hidden_layer1=120,dropout=0.5,lr=0.001,epochs=12, train_data='', model=''):
    '''
